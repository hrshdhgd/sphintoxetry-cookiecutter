...
This kickstarts an interactive session where you declare the following:
 ...
 - `github_token_variable_name_for_doc_deployment`: The github token variable name for document deployment using `Sphinx`. [defaults to: `GH_TOKEN`]
 - `github_token_variable_name_for_pypi_deployment`: The github token variable name which aligns with your autogenerated PyPI token for making releases. [defaults to: `PYPI_TOKEN`]
